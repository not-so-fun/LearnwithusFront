            ...
            <div className='ProfileTry__Left__ProfileInformation'>
                <div className='ProfileTry__Left__ProfileInformation__Profile'>
                    ...
                    <div className='ProfileTry__Left__ProfileInformation__Profile__ProfileData'>
                        <h2 className="ProfileTry__Left__ProfileInformation__Profile__ProfileData__Heading">Pasang Sherpa</h2>
                        <p className="ProfileTry__Left__ProfileInformation__Profile__ProfileData__Paragraph">Kathmandu,Nepal</p>
                    </div>
                ...
                <div className='ProfileTry__Left__ProfileInformation__Question'>
                    <div className='ProfileTry__Left__ProfileInformation__Question__QuestionAsked'>
                        <h1 className="ProfileTry__Left__ProfileInformation__Question__QuestionAsked__Heading">56</h1>
                        <h4>Questions Asked</h4>
                    </div>
                    <div className='ProfileTry__Left__ProfileInformation__Question__QuestionAsked'>
                    <h1 className="ProfileTry__Left__ProfileInformation__Question__QuestionAsked__Heading">100</h1>
